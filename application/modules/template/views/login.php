    ...
    <div class="container-center">
        ...
        <div class="panel panel-bd">
            ...
            <div class="panel-body" style="background-color:#B2BEB5">
                <?php echo form_open('login', 'id="loginForm" aautocomplete="new-password" novalidate') ?>
                <div class="form-group">
                    <label class="control-label" for="username">Username</label>
                    <input type="text" placeholder="Username" title="Username" required="" value="" name="email" autocomplete="off" id="email" class="form-control">
                </div>
                <div class="form-group">
                    <label class="control-label" for="password"><?php echo display('password') ?></label>
                    <input type="password" title="Please enter your password" placeholder="<?php echo display('password') ?>" required="" value="" name="password" id="password" autocomplete="off" class="form-control">

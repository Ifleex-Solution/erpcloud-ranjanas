...
<body class="hold-transition sidebar-mini"  style="background-color:#B2BEB5">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper"  style="background-color:#B2BEB5">
            ...
            <div class="content <?php $gui_segment = $this->uri->segment(1);
                ...
                if ($gui_p != 'gui_pos') {
                ?>
                    <ol class="breadcrumb" style="background-color:#B2BEB5">
        ...
        <footer class="main-footer" style="background-color:#B2BEB5">

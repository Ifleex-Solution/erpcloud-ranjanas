        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                echo form_open_multipart("add_user/$user->user_id") ?>
                    ...
                    <div class="form-group row">
                        <label for="email" class="col-sm-2 col-form-label text-d">Username <span class="text-danger">*</span></label>
                        <div class="col-sm-8">
                            <input name="email" class="form-control" type="text" placeholder="Username" id="email_id" value="<?php echo $user->email ?>">
                        </div>
                    </div> 

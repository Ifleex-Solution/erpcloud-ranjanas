                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control text-right" id="sell_price" name="price" type="text" placeholder="0.00" tabindex="6" min="0" value="<?php echo $product->price ?>">
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    if (id != null) {
        prod_id = document.getElementById("product_id").value
        if (open != null) {
        ...
        async function checkProduct() {
            try {
                let response = await $.ajax({
                    ...
                    data: {
                        id: document.getElementById('product_id').value.toString().padStart(6, '0'),
                    }
                });
                ...
                if (data === "success") {
                    ...
                    if (prod_id == document.getElementById('product_id').value.toString().padStart(6, '0')) {
                        return true;
                    } else {
                        alert("Product Id already exsist");
                        return false;
                    }
                }

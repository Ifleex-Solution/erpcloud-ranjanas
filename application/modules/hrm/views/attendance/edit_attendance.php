    ...
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body" style="background-color:#B2BEB5">
                ...
                <div class="form-group row">
                    <label for="sign_in" class="col-sm-3 col-form-label"><?php echo display('sign_in') ?> <span
                            class="text-danger"> * </span></label>
                    <div class="col-sm-9">
                        <input name="sign_in"
                            value="<?php echo @$sign_in = html_escape(date("H:i", strtotime($data[0]['sign_in']))) ?>"
                            class="form-control timepicker" type="text" id="sign_in" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="sign_out"
                            value="<?php echo @$sign_out = html_escape(date("H:i", strtotime($data[0]['sign_out']))); ?>"

            ...
            <div class="panel-body" style="background-color:#B2BEB5">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        ...
                        <?php echo  form_open('hrm/attendance/bdtask_create_break') ?>
                        ...
                        <div class="form-group row ">
                            <label for="time" class="col-sm-3 col-form-label"><?php echo display('break_in') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-9 picker-container">
                        ...
                        <div class="form-group row ">
                            <label for="time" class="col-sm-3 col-form-label"><?php echo display('break_out') ?></label>
                            <div class="col-sm-9 picker-container">

...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="background-color:#B2BEB5">
        <div class="modal-content" style="width: 1000px;" style="background-color:#B2BEB5">
                ...
                <div class="row" style="background-color:#B2BEB5">
                    <div class="col-sm-12">
                        <div class="panel panel-bd lobidrag">
                            ...
                            <div class="panel-body" style="background-color:#B2BEB5">
                                <div class="table-responsive">
                                    <table class="table table-bordered" cellspacing="0" width="100%" id="InvList2">
                                        <thead>
                                            <tr>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-bd lobidrag">
                            ...
                            <div class="panel-body" style="background-color:#B2BEB5">
                                <div class="table-responsive">
                                    <table class="table  table-bordered" cellspacing="0" width="100%" id="InvListTotalSales">
                                        <thead>
                                            <tr>
                                                <!-- <th>From Date</th>
                                                <th>To Date</th> -->
    ...
    function addinvoice(t, data) {
        ...
        if (count == limits)
            ...
            if (mode === "+") {
                ...
                if (data.price == null) {
                    row1 = row1 + "<td><input type='text'  name='product_rate[]' onkeyup='bdtask_invoice_quantitycalculate(" +
                ...
                if (data.price == null) {
                    row2 = row2 + "<td><input type='number'  name='product_rate[]' onkeyup='bdtask_invoice_quantitycalculate(" +
                        count + ",event);' onchange='bdtask_invoice_quantitycalculate(" + count + ",event);' tabindex='" + tab5 + "' id='price_item_" + count + "' class='common_rate price_item" +
                        count + " form-control text-right' required placeholder='0.00' min='0' /></td>"
            ...
            if (tcount == 9) {
                if ($("#employeeId_" + item).val() != "") {
                    ...
                    if (itemIndex !== -1) {
                        ...
                        console.log($("#employeeId_" + item).val())
                        arrItem.push({
                            invoiceId: item,
...
<script>
    ...
    function reprintInvoice(invoiceId, type) {
        if (confirm("Do you want to reprint this record")) {
            $.ajax({
                type: "post",
                url: $('#base_url').val() + 'invoice/invoice/reprint',
                data: {
                    invoice_id: invoiceId,
